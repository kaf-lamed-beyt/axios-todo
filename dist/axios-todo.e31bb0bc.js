...
},{"./noConflict":"node_modules/@babel/polyfill/lib/noConflict.js","core-js/library/fn/global":"node_modules/core-js/library/fn/global.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var API__URL = 'https://jsonplaceholder.typicode.com';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("".concat(API__URL, "/todos"));
...
var createListElement = function createListElement(item) {
  // creates an HTML list element.
  var listItem = document.createElement('li'); // attach an id such that when an element is clicked, it gets deleted

  listItem.id = item.id;
  listItem.appendChild(document.createTextNode(item.title));

  listItem.onclick = /*#__PURE__*/function () {
...
var addTodoItemToDOM = function addTodoItemToDOM(todos) {
...
var formEvent = form.addEventListener('submit', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    var todoName, todoId, todo, addedTodo;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            e.preventDefault();
            todoName = document.querySelector("#todos__name").value;
            todoId = document.querySelector("#todos__id").value;
            todo = {
              todoName: todoName,
              todoId: todoId
            };
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return _axios.default.post("".concat(API__URL, "/todos"), todo);

          case 3:
            res = _context5.sent;
            addedTodo = res.data;
            console.log("Added a new Todo Item", addedTodo);
            return _context5.abrupt("return", addedTodo);

          case 9:
            _context5.prev = 9;
            _context5.t0 = _context5["catch"](0);
            comsole.error(_context5.t0);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return _axios.default.delete("".concat(API__URL, "/todos/").concat(id));
...
var removeTodo = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(e, listItem) {
    var id;
...
//# sourceMappingURL=/axios-todo.e31bb0bc.js.map